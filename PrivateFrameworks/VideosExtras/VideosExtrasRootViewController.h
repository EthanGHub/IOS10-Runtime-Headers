...
@class IKAppContext, NSLayoutConstraint, NSObject, NSString, UINavigationController, UITraitCollection, UIView, VideosExtrasArtworkDataSource, VideosExtrasContext, VideosExtrasFeatureContainerViewController, VideosExtrasMainTemplateViewController, VideosExtrasNavigationController;
