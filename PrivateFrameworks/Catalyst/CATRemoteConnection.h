...
@class CATHTTPMessageParser, CATRemoteConnectionSocketOptions, NSArray, NSError, NSInputStream, NSMutableArray, NSMutableData, NSOutputStream, NSString, NSTimer;
