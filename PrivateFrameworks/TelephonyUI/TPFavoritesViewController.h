...
@class CNAvatarViewControllerSettings, CNContactFormatter, CNContactStore, NSArray, NSIndexSet, NSMutableArray, NSMutableDictionary, TPFavoritesController, UIView;
...
@property(readonly, nonatomic) NSMutableDictionary *avatarViewControllers; // @synthesize avatarViewControllers=_avatarViewControllers;
@property(readonly, nonatomic) NSMutableArray *avatarViewControllerPool; // @synthesize avatarViewControllerPool=_avatarViewControllerPool;
