...
- (_Bool)persistChangesToAlgorithmicFaceGroups:(id)arg1 andFaces:(id)arg2 returnFaceGroupsWithoutKeyFace:(id *)arg3 error:(id *)arg4;
...
- (id)facesByFaceLocalIdentifiers:(id)arg1 withFaceprintVersion:(unsigned int)arg2 excludeClustered:(_Bool)arg3 error:(id *)arg4;
...
- (id)facesForFaceLocalIdentifiers:(id)arg1 withFaceprintVersion:(unsigned int)arg2 excludeClustered:(_Bool)arg3 error:(id *)arg4;
- (id)unclusteredFaceLocalIdentifiersWithFaceprintVersion:(unsigned int)arg1 error:(id *)arg2;
- (id)facesWithFaceprintVersion:(unsigned int)arg1 excludeClustered:(_Bool)arg2 maxCount:(unsigned long long)arg3 error:(id *)arg4;
