...
- (id)_produceAssetAnalysisOrAdditionalJobWithForWorkerType:(short)arg1 workInfoReaderMode:(id)arg2 scenario:(unsigned long long)arg3 additionalStatesToExclude:(id)arg4 canUseNetwork:(_Bool)arg5 defaultsDisabledKey:(id)arg6 failureReason:(id *)arg7;
