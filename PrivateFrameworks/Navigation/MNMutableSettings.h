...
@property(nonatomic) _Bool useTraceETAResponses; // @dynamic useTraceETAResponses;
@property(nonatomic) _Bool useTraceDirectionsResponses; // @dynamic useTraceDirectionsResponses;
