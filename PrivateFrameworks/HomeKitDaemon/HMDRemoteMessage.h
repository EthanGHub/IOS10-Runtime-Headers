...
- (id)initWithName:(id)arg1 destination:(id)arg2 payload:(id)arg3 type:(long long)arg4 timout:(double)arg5 secure:(_Bool)arg6;
- (id)initWithName:(id)arg1 destination:(id)arg2 payload:(id)arg3 type:(long long)arg4 timout:(double)arg5 secure:(_Bool)arg6 restriction:(unsigned long long)arg7;
