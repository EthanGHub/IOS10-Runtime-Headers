...
@property(nonatomic, getter=isResidentEnabled) _Bool residentEnabled; // @synthesize residentEnabled=_residentEnabled;
...
- (void)_updateResidentEnabledOnThisDevice:(_Bool)arg1 message:(id)arg2;
...
- (void)notifyCurrentHomeUpdated:(id)arg1 isLocalUpdate:(_Bool)arg2;
...
- (void)_handleMergeWithCloudHomeData1:(id)arg1 cloudHomeData2:(id)arg2 cloudHomeData3:(id)arg3 needConflictResolution:(_Bool)arg4 homeDataFetechedTransaction:(id)arg5 syncCompletion:(CDUnknownBlockType)arg6;
...
- (void)_runUploadHomeConfigToCloud:(CDUnknownBlockType)arg1;
...
- (void)_loadMessageDispatcher:(id)arg1 remoteMessageDispatcher:(id)arg2 accessoryBrowser:(id)arg3 messageFilterChain:(id)arg4 homeData:(id)arg5 identityRegistry:(id)arg6 appRegistry:(id)arg7 accountRegistry:(id)arg8 reloadData:(_Bool)arg9;
