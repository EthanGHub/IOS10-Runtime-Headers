...
@class HMDCameraVideoTier, NSArray, NSDictionary, NSString;
...
+ (id)logCategory;
@property(nonatomic, getter=is4x3Mode) _Bool s4x3Mode; // @synthesize s4x3Mode=_s4x3Mode;
...
- (_Bool)_is16x9Resolution:(id)arg1;
- (_Bool)_is4x3Resolution:(id)arg1;
