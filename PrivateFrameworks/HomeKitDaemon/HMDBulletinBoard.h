...
@class BBDataProviderConnection, HMDBulletinProvider, HMDHomeManager, NSArray;
...
- (void)_insertBulletinWithTitle:(id)arg1 imageURL:(id)arg2 message:(id)arg3 recordID:(id)arg4 bulletinContext:(struct NSDictionary *)arg5 actionContext:(struct NSDictionary *)arg6;
