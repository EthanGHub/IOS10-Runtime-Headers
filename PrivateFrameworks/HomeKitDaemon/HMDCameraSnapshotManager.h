...
@class HMDAccessory, HMDCameraSnapshotMonitorEvents, HMDSnapshotLocalSession, HMDSnapshotRequestHandler, HMDSnapshotSlotManager, HMFMessageDispatcher, NSMutableDictionary, NSString, NSUUID;
