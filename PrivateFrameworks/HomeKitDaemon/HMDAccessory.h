...
- (void)_enableNotification:(_Bool)arg1 forCharacteristics:(id)arg2 message:(id)arg3;
- (void)enableNotification:(_Bool)arg1 forCharacteristics:(id)arg2 message:(id)arg3;
