...
@class PXOneUpPresentation, PXPhotosDetailsContext, PXRegionOfInterest, PXZoomAnimationCoordinator, UIFocusUpdateContext;
...
- (void)widgetHostingViewWillAppear:(_Bool)arg1;
