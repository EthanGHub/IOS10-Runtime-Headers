...
@class NSIndexPath, NSString, PXPeopleHomeDataSource, PXPeopleProgressManager, UIBarButtonItem, UILongPressGestureRecognizer, UIProgressView;

@interface PXPeopleHomeViewController : UICollectionViewController <PXPeopleDragAndDropCollectionViewDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSourcePrefetching, UIViewControllerPreviewingDelegate, PXPeopleHomeDataSourceDelegate>
{
    struct {
...
@property(retain, nonatomic) NSIndexPath *proposedDropIndex; // @synthesize proposedDropIndex=_proposedDropIndex;
@property(retain, nonatomic) NSIndexPath *sourceDragIndex; // @synthesize sourceDragIndex=_sourceDragIndex;
