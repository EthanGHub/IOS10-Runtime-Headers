...
@class ISDataProvider, ISURLRequestPerformance, NSArray, NSCountedSet, NSData, NSMutableData, NSString, NSURLConnection, NSURLRequest, NSURLResponse, NSURLSessionTask, SSAuthenticationContext, SSMutableURLRequestProperties, SSURLRequestProperties, SSURLSessionManager;
