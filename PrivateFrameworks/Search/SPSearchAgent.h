...
@class NSArray, NSDictionary, NSMutableArray, NSString, SPDaemonQueryToken, SPSearchResultSection;
...
- (void)searchDaemonQuery:(id)arg1 addedResults:(struct NSObject *)arg2;
- (void)searchDaemonQuery:(id)arg1 gotResultSet:(id)arg2 replace:(_Bool)arg3 complete:(_Bool)arg4 finished:(_Bool)arg5;
...
- (void)addDeserializer:(struct NSObject *)arg1;
