...
@class NSArray, NSString, SBUIIconForceTouchController, UILongPressGestureRecognizer, UIStackView, UIView;
...
@property(retain, nonatomic) SBUIIconForceTouchController *iconForceTouchController; // @synthesize iconForceTouchController=_iconForceTouchController;
