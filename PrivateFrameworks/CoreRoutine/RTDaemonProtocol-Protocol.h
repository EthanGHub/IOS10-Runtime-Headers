...
@class CLLocation, GEOMapItemStorage, NSData, NSDate, NSPredicate, NSString, NSUUID, RTAction, RTPredictedLocationOfInterest;
...
- (void)vehicleEventAtLocation:(CLLocation *)arg1 notes:(NSString *)arg2 reply:(void (^)(void))arg3;
