...
@class NSCache, NSDate, NSMutableDictionary, NSMutableSet, NSObject, NSString, NTKComplicationController, NTKComplicationDisplayWrapperView, NTKDelayedBlock, NTKFace, NTKFaceEditView, NTKFaceView, UIImageView, UIView;
...
@interface NTKFaceViewController : UIViewController <NTKFaceEditViewDelegate, NTKComplicationPickerViewDataSource, NTKFaceObserver, NTKClockIconZoomAnimator, NTKClockHardwareInput, NTKFaceViewDelegate>
{
    ...
    NSMutableSet *_interactiveComplicationDisplays;
...
- (void)_updateInteractivityOfComplicationDisplay:(id)arg1;
