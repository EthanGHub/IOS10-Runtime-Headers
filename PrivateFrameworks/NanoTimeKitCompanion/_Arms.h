...
@class NSArray, NTKCharacterTexture;
...
@interface _Arms : _Geometry
{
    ...
    NTKCharacterTexture *_texHandHour;
    NTKCharacterTexture *_texArm;
}
...
@property(retain, nonatomic) NTKCharacterTexture *texArm; // @synthesize texArm=_texArm;
@property(retain, nonatomic) NTKCharacterTexture *texHandHour; // @synthesize texHandHour=_texHandHour;
