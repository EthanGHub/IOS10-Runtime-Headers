...
@class HKRingsView, NSDate, NSNumberFormatter, NSString, NTKActivityFaceControl, NTKActivityFaceViewFactory, NTKDigitalTimeLabel, NTKPolygonCylinderView, UILabel, UIView;
...
@interface NTKActivityDigitalFaceView : NTKFaceView <NTKActivityFaceViewFactoryDelegate>
{
    ...
    NSNumberFormatter *_activityLabelNumberFormatter;
