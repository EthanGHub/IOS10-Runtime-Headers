...
- (id)registerItemGroupSet:(id)arg1 operation:(id)arg2 shouldChunk:(_Bool)arg3 fetchOnly:(_Bool)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (id)_contextToRegisterItemGroup:(id)arg1 operation:(id)arg2 fetchOnly:(_Bool)arg3 options:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
