...
@class ACAccountStore, EAAccessory, HMHomeManager, NSArray, NSDictionary, NSObject, NSSet, NSString, PSSearchController, PSSpecifier, UIViewController, VSAAccountStore;
