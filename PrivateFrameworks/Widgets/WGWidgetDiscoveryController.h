...
@class NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSPointerArray, NSString, WGWidgetPersistentStateController;
...
- (void)requestUnlockWithCompletion:(CDUnknownBlockType)arg1;
