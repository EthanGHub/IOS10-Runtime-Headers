...
@class NSXPCConnection, SGAsset, SGQueryPredictions, SGServiceContext, SGSqlEntityStore, SGSuggestHistory;
...
- (void)_suggestionsFromMessage:(id)arg1 options:(unsigned long long)arg2 dissectIfNecessary:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)_suggestionsFromMessageWithIdentifier:(id)arg1 source:(id)arg2 options:(unsigned long long)arg3 completion:(CDUnknownBlockType)arg4 providedBy:(CDUnknownBlockType)arg5 dissectIfNecessary:(_Bool)arg6;
