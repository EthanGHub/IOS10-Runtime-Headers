...
@class NSCache, NSDictionary, NSSet, NSString, SGBloomFilter, SGDatabaseJournal, SGDuetBridge, SGJournal, SGSpotlightContactsAdapter, SGSqliteDatabase, SGSuggestHistory;
