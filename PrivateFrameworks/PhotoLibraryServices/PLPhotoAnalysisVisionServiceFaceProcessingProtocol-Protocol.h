...
- (void)reclusterFacesWithThreshold:(NSNumber *)arg1 withContext:(NSDictionary *)arg2 reply:(void (^)(_Bool, NSError *))arg3;
- (void)resetFaceClusteringStateWithContext:(NSDictionary *)arg1 reply:(void (^)(_Bool, NSError *))arg2;
- (void)resetFaceDetectionStateWithContext:(NSDictionary *)arg1 reply:(void (^)(_Bool, NSError *))arg2;
