...
@property(nonatomic) _Bool hasSetFaceAnalysisData; // @synthesize hasSetFaceAnalysisData=_hasSetFaceAnalysisData;
...
- (id)pictureTransferProtocolInformationWithAlbumsObjectIDs:(id)arg1 firstAsset:(_Bool)arg2;
...
- (void)handleDelayedAnalysisStateUpdateForAdditionalAttributes:(id)arg1 withChangedValues:(id)arg2 modificationDateUpdated:(_Bool)arg3 managedObjectContext:(id)arg4;
- (void)handleDelayedAnalysisStateUpdateWithChangedValues:(id)arg1 modificationDateUpdated:(_Bool)arg2 managedObjectContext:(id)arg3;
