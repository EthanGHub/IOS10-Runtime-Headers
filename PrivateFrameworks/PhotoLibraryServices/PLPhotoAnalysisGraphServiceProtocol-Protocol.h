...
- (void)requestSetShowHolidayCalendarEvents:(_Bool)arg1 context:(NSDictionary *)arg2 reply:(void (^)(NSError *))arg3;
- (void)requestIsShowingHolidayCalendarEventsWithContext:(NSDictionary *)arg1 reply:(void (^)(_Bool, NSError *))arg2;
