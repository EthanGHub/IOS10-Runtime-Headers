...
- (void)handleIncomingBatch:(id)arg1 outHasResourceChanges:(_Bool *)arg2;
...
- (void)_handleAssetRecords:(id)arg1 inLibrary:(id)arg2 withChangeBatch:(id)arg3 hasResourceChange:(_Bool *)arg4;
- (id)_findMaster:(id)arg1 fromAdditionalRecordInBatch:(id)arg2 inLibrary:(id)arg3;
- (void)_handleMasterRecords:(id)arg1 inLibrary:(id)arg2 hasResourceChange:(_Bool *)arg3;
