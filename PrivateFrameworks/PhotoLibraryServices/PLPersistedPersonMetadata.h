...
- (void)_readMetadata;
- (id)description;
- (_Bool)_insertRejectedFacesOnPerson:(id)arg1 fromDataInManagedObjectContext:(id)arg2;
- (_Bool)_insertDetectedFacesOnPerson:(id)arg1 fromDataInManagedObjectContext:(id)arg2;
...
- (_Bool)updateFacesInPerson:(id)arg1 fromDataInManagedObjectContext:(id)arg2;
