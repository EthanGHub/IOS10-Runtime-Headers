...
#import <PhotosPlayer/ISLivePhotoPlayerSource-Protocol.h>
...
@class CALayer, ISAudioVolumeInput, ISGestureInput, ISLivePhotoPlayer, ISMutedAudioInput, ISPlaybackSpec, ISPlayer, ISPlayerOutputContent, ISVitalityFilter, ISVitalityInput, ISWrappedAVPlayer, NSError, NSHashTable, NSMutableSet, NSObject, NSString, UIGestureRecognizer, UIScrollView, _ISAVPlayerView, _ISCrossfadeView, _ISPlayerDebugView, _ISTargetView;
@protocol ISPlayerViewDelegate, NSObject, OS_dispatch_queue;

@interface ISPlayerView : UIView <ISGestureInputDelegate, ISPlayerOutput, UIGestureRecognizerDelegate, ISPlayerChangeObserver, ISPlayerChangeObserverPrivate, ISPlayerDelegate, ISLivePhotoPlayerSource>
{
    ISPlayer *_player;
...
@property(nonatomic, setter=_setInteracting:) _Bool isInteracting; // @synthesize isInteracting=_isInteracting;
