...
- (id)initWithInitialLayoutInfo:(id)arg1 playbackStyle:(long long)arg2 keyTime:(CDStruct_1b6d18a9)arg3 photoTransitionDuration:(double)arg4 crossfadeDuration:(double)arg5;
