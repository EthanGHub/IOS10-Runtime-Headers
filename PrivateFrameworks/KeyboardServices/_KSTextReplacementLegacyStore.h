...
- (_Bool)retirePersistentStoreAtURL:(id)arg1;
- (_Bool)migrateEntriesFromStoreAtURL:(id)arg1;
- (_Bool)mergeShortcut:(id)arg1 phrase:(id)arg2 fromContext:(id)arg3;
- (_Bool)shouldMergeShortcut:(id)arg1 phrase:(id)arg2 intoContext:(id)arg3;
