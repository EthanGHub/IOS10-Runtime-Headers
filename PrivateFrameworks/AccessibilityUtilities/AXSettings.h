...
@property(nonatomic) _Bool voiceOverShouldRouteToSpeakerWithProximity;
...
- (id)_createAndSaveRecipeForInterfaceOrientedPoint:(struct CGPoint)arg1 forLongPress:(_Bool)arg2;
