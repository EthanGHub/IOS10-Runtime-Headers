...
- (id)_valuesForStandardForm:(id)arg1 inDomain:(id)arg2 usingOnlyAddressBookData:(_Bool)arg3 matches:(id *)arg4 preferredLabel:(id)arg5 multiRoundAutoFillManager:(id)arg6 wantAllMatches:(_Bool)arg7 contact:(id)arg8 shouldRemoveCompanyFromAutoFillMatchesIfHomeAddressFound:(_Bool)arg9 existingMatches:(id)arg10 allowingIdentifiedAddressBookLabelToOverridePreferredIdentifier:(_Bool)arg11;
...
- (id)valuesForStandardForm:(id)arg1 inDomain:(id)arg2 usingOnlyAddressBookData:(_Bool)arg3 matches:(id *)arg4 preferredLabel:(id)arg5 multiRoundAutoFillManager:(id)arg6 shouldRemoveCompanyFromAutoFillMatchesIfHomeAddressFound:(_Bool)arg7 contact:(id)arg8 allowingIdentifiedAddressBookLabelToOverridePreferredIdentifier:(_Bool)arg9;
