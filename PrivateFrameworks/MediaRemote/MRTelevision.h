...
@property(nonatomic) _Bool isCoalescingClientStateUpdatesConfigMessages; // @synthesize isCoalescingClientStateUpdatesConfigMessages=_isCoalescingClientStateUpdatesConfigMessages;
