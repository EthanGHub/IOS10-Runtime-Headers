...
@class BLTPingSubscriber, NNMKAccountsSyncServiceServer, NNMKDeviceSyncRegistry, NNMKFetchesSyncServiceServer, NNMKMessageContentSyncServiceServer, NNMKMessagesSyncServiceServer, NNMKPairedDeviceInfo, NNMKProtectedContentSyncServiceServer, NNMKProtectedSyncServiceServer, NNMKProtoFetchRequest, NSMutableDictionary, NSMutableSet, NSObject, NSString, NSURL, PSYSyncCoordinator;
