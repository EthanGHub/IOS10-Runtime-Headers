...
@class IKAppContext, IKAppDocument, IKAppMediaItemBridge, IKAppPlaylistBridge, IKDOMDocument, IKJSPlayer, NSDate, NSNumber, NSString;
...
@interface IKAppPlayerBridge : NSObject <IKDOMFeature>
{
    ...
    _Bool _modalOverlayDismissable;
