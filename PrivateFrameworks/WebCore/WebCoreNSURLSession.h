...
// Property attributes: T^{PlatformMediaResourceLoader=^^?{atomic<int>=Ai}},R,D
...
- (void)dealloc;
-     // Error parsing type: @40@0:8^{PlatformMediaResourceLoader=^^?{atomic<int>=Ai}}16@24@32, name: initWithResourceLoader:delegate:delegateQueue:
