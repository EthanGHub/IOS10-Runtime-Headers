...
- (void)queue_setUserInteractive:(_Bool)arg1;
...
- (void)setUserInteractive:(_Bool)arg1;
@property(readonly, nonatomic, getter=isUserInteractive) _Bool userInteractive;
...
- (void)dealloc;
- (id)initWithEndpoint:(id)arg1 bundleIDs:(id)arg2 states:(unsigned int)arg3 isUserInteractive:(_Bool)arg4;
