...
- (struct CGImage *)_newCGImageWithBox:(long long)arg1 bitmapSize:(struct CGSize)arg2 scale:(double)arg3 offset:(struct CGPoint)arg4 fillBackground:(_Bool)arg5 withRotation:(_Bool)arg6 withAntialiasing:(_Bool)arg7;
...
- (void)_drawThumbnailWithBox:(long long)arg1 inContext:(struct CGContext *)arg2 withRotation:(_Bool)arg3 withAntialiasing:(_Bool)arg4 isThumbnail:(_Bool)arg5;
