...
@interface CALNRemoteEventProvider : CALNRemoteDataProvider
{
    ...
    CDUnknownBlockType _requestRefresh;
    CDUnknownBlockType _cancelRefreshRequest;
...
@property(copy, nonatomic) CDUnknownBlockType cancelRefreshRequest; // @synthesize cancelRefreshRequest=_cancelRefreshRequest;
@property(copy, nonatomic) CDUnknownBlockType requestRefresh; // @synthesize requestRefresh=_requestRefresh;
...
- (void)respond:(_Bool)arg1 toCalendarInvite:(id)arg2;
