...
- (oneway void)startSpeechRecognitionWithLanguage:(NSString *)arg1 task:(NSString *)arg2 context:(NSArray *)arg3 profile:(NSData *)arg4 userData:(NSDictionary *)arg5 narrowband:(_Bool)arg6 detectUtterances:(_Bool)arg7 maximumRecognitionDuration:(double)arg8 didStartHandler:(void (^)(NSString *, NSError *))arg9;
