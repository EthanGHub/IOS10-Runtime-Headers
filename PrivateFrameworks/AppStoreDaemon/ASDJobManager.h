...
@class ASDJobManagerOptions, NSArray, NSHashTable, NSMutableSet, NSString, NSXPCConnection, NSXPCListener;
@protocol OS_dispatch_queue;

@interface ASDJobManager : NSObject <NSXPCListenerDelegate, ASDJobManagerClient>
{
