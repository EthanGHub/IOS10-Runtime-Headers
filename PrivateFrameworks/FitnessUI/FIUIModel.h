...
- (void)loadLocationSeriesWithUUID:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;
- (void)loadLocationSeriesForSample:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;
