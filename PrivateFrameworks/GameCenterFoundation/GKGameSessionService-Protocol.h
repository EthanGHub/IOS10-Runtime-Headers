...
- (oneway void)sendMessageForSessionWithID:(NSString *)arg1 withLocalizedFormatKey:(NSString *)arg2 arguments:(NSArray *)arg3 userMessage:(NSString *)arg4 data:(NSData *)arg5 recipientIDs:(NSArray *)arg6 badgePlayers:(_Bool)arg7 handler:(void (^)(NSError *))arg8;
