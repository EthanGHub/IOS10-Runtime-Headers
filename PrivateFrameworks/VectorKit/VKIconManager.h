...
- (id)_artworkForStyleAttributes:(id)arg1 labelStyle:(struct VKLabelStyle)arg2 contentScale:(double)arg3 size:(long long)arg4 customIconID:(unsigned long long)arg5 transparent:(_Bool)arg6;
