...
- (void)videoConference:(VideoConference *)arg1 didDisableCaptions:(_Bool)arg2 error:(NSError *)arg3;
- (void)videoConference:(VideoConference *)arg1 didEnableCaptions:(_Bool)arg2 error:(NSError *)arg3;
