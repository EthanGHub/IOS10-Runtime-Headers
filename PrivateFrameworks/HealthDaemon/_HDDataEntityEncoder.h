...
@property(readonly, copy, nonatomic) CDUnknownBlockType metadataKeyFilter; // @synthesize metadataKeyFilter=_metadataKeyFilter;
@property(readonly, nonatomic) HDDataProvenanceCache *dataProvenanceCache; // @synthesize dataProvenanceCache=_dataProvenanceCache;
@property(readonly, nonatomic) HDMetadataValueStatement *metadataValueStatement; // @synthesize metadataValueStatement=_metadataValueStatement;
- (void).cxx_destruct;
- (void)finish;
