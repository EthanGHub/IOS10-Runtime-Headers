...
@class HDContentProtectionManager, HDDatabaseJournal, HDProfile, HDSQLiteDatabasePool, NSHashTable, NSLock, NSMutableArray, NSMutableDictionary, NSOperationQueue, NSString;
...
- (_Bool)_transactionQueue_performWithOptions:(unsigned long long)arg1 database:(id)arg2 error:(id *)arg3 usingBlock:(CDUnknownBlockType)arg4 inaccessibilityHandler:(CDUnknownBlockType)arg5;
