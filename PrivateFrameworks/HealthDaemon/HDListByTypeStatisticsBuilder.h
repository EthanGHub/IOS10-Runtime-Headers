...
- (_Bool)_enumerateSummaries:(id)arg1 withDatabase:(id)arg2 handler:(CDUnknownBlockType)arg3 error:(id *)arg4;
...
- (id)_enumerateFilteredSampleTypes:(id)arg1 database:(id)arg2 handler:(CDUnknownBlockType)arg3 error:(id *)arg4;
- (id)updatedSummaries;
