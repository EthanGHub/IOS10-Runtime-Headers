...
+ (_Bool)_insertDataObject:(id)arg1 provenance:(id)arg2 creationDateSetter:(CDUnknownBlockType)arg3 profile:(id)arg4 database:(id)arg5 skipInsertionFilter:(_Bool)arg6 insertionFilters:(id)arg7 insertedEntityID:(id *)arg8 error:(id *)arg9;
