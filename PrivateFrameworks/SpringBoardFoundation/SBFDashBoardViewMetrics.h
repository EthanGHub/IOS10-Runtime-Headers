...
+ (struct CGRect)suggestedFrameForDateViewInScreenCoordinates:(struct CGRect)arg1 centeredX:(_Bool)arg2;
...
+ (struct CGRect)suggestedFrameForSearchNavigationBarForPageBounds:(struct CGRect)arg1;
