...
@interface SBFWallpaperView : UIView <_UISettingsKeyObserver, SBFLegibilitySettingsProvider>
{
    ...
    _Bool _darkensContentsToEnsureLegibility;
...
@property(nonatomic) _Bool darkensContentsToEnsureLegibility; // @synthesize darkensContentsToEnsureLegibility=_darkensContentsToEnsureLegibility;
