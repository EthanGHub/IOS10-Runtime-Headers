...
@class NSData, NSDate, NSHashTable, NSMutableArray, NSString, PCPersistentTimer, SBFAuthenticationAssertion, SBFAuthenticationAssertionManager;
@protocol SBFAuthenticationPolicy, SBFUserAuthenticationModel;

@interface SBFUserAuthenticationController : NSObject <SBFUserAuthenticationModelDelegate, SBFAuthenticationStatusProvider, SBFPasscodeFieldChangeObserver>
{
...
+ (_Bool)_shouldTreatExtendedKeybagStateAsLocked;
...
- (void)_revokeAuthenticationImmediately:(_Bool)arg1;
- (_Bool)_shouldRevokeAuthenticationNow;
- (void)_updateAuthenticationStateImmediately:(_Bool)arg1;
