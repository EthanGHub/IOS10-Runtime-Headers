...
@interface TUCallCapabilitiesState : NSObject <NSSecureCoding, NSCopying, TUPubliclyAccessibleCopying>
{
    ...
    _Bool _supportsOutgoingTelephonyRelayCalling;
    _Bool _supportsOutgoingFaceTimeAudioRelayCalling;
    _Bool _supportsOutgoingFaceTimeVideoRelayCalling;
...
@property(nonatomic) _Bool supportsOutgoingFaceTimeVideoRelayCalling; // @synthesize supportsOutgoingFaceTimeVideoRelayCalling=_supportsOutgoingFaceTimeVideoRelayCalling;
@property(nonatomic) _Bool supportsOutgoingFaceTimeAudioRelayCalling; // @synthesize supportsOutgoingFaceTimeAudioRelayCalling=_supportsOutgoingFaceTimeAudioRelayCalling;
@property(nonatomic) _Bool supportsOutgoingTelephonyRelayCalling; // @synthesize supportsOutgoingTelephonyRelayCalling=_supportsOutgoingTelephonyRelayCalling;
