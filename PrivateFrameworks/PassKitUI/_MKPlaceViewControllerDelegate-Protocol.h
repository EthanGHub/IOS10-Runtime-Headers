...
- (void)placeViewController:(_MKPlaceViewController *)arg1 removeFavoriteForMapItem:(MKMapItem *)arg2 result:(void (^)(NSArray *, NSError *))arg3;
- (void)placeViewController:(_MKPlaceViewController *)arg1 addFavoriteForMapItem:(MKMapItem *)arg2 title:(NSString *)arg3 result:(void (^)(NSArray *, NSError *))arg4;
