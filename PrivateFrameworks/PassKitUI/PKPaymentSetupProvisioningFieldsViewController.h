...
@class CLInUseAssertion, NSString, PKPaymentProvisioningController, PKPaymentSetupCardDetailsFooterView, PKPaymentVerificationController, RemoteUIController;

@interface PKPaymentSetupProvisioningFieldsViewController : PKPaymentSetupFieldsViewController <UITextFieldDelegate, RemoteUIControllerDelegate, PKPaymentVerificationControllerDelegate>
{
