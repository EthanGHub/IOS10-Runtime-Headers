...
@class NSNumberFormatter, NSString, PKPassPropertiesSummaryItem, PKPaymentMessage, PKPaymentPass, PKPaymentTransaction, UITableView;
...
- (_Bool)_isSectionIndexOfProperties:(long long)arg1;
- (_Bool)_passContainsProperties;
