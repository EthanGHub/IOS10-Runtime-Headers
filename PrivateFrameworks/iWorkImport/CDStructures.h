...
@class NSObject, NSSet, NSString, NSUUID, TSCEFormulaRewriteInfo_RowColumnInfo, TSCEFormulaRewrite_MergeOriginMovedInfo, TSCEFormulaRewrite_RegionMergedInfo, TSCEFormulaRewrite_RegionMovedInfo, TSCERewriteTableIDInfo, TSCETableTransposedInfo, TSCH3DScene, TSCH3DShaderVariable, TSCHChartInfo, TSCHChartSeriesType, TSCHChartType, TSTCell, TSUCustomFormat;
...
typedef struct {
    struct TSUCellCoord mPreviousCellID;
    struct TSUCellCoord mCellID;
    TSTCell *mCell;
    struct TSTCellStorage *mCellRef;
    struct TSUCellRect mMergeRange;
    _Bool mStyleOnly;
...
typedef union {
    ...
    TSCEFormulaRewrite_MergeOriginMovedInfo *mMergeOriginMovedInfo;
