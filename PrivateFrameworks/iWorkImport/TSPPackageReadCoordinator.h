...
@class NSError, NSMapTable, NSMutableArray, NSMutableSet, NSObject, NSString, NSURL, NSUUID, TSPDocumentResourceDataProvider, TSPDocumentRevision, TSPFinalizeHandlerQueue, TSPObject, TSPObjectContext, TSPPackage, TSPPackageMetadata, TSPPersistedObjectUUIDMap;
