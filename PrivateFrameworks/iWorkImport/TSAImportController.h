...
@class NSArray, NSDictionary, NSError, NSMutableArray, NSMutableSet, NSOperationQueue, NSString, NSURL, NSUUID, TSAUbiquitousRefreshQueue, TSPObjectContext, TSUProgressContext, TSUTemporaryDirectory;
...
@property(readonly, nonatomic) NSArray *incompatibleMovieInfosUnplayableOnAllDevices;
@property(readonly, nonatomic) NSArray *incompatibleMovieInfosUnplayableOnThisDevice;
