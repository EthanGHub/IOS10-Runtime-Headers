...
@class NSString, TSCECalculationEngine, TSTReferenceColorHelper, TSTUidRangeRef;
...
- (void)p_buildASTNodeArray:(struct TSCEASTNodeArray *)arg1 forRangeComponent:(struct TSUCellCoord)arg2 stickyBits:(unsigned char)arg3 hostCell:(struct TSUCellCoord)arg4;
- (id)formulaPlainText;
