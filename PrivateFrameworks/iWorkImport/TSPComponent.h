...
@class NSMapTable, NSMutableSet, NSString, TSPComponentExternalReferenceMap, TSPComponentObjectUUIDMap, TSPObject, TSPObjectReferenceMap;
...
- (void)setPackageIdentifier:(unsigned char)arg1 preferredLocator:(id)arg2 locator:(id)arg3 isStoredOutsideObjectArchive:(_Bool)arg4 rootObjectOrNil:(id)arg5 archivedObjects:(id)arg6 externalReferenceMap:(id)arg7 dataReferences:(id)arg8 readVersion:(unsigned long long)arg9 writeVersion:(unsigned long long)arg10 componentObjectUUIDMap:(id)arg11 objectReferenceMap:(id)arg12 saveToken:(unsigned long long)arg13 encodedLength:(unsigned long long)arg14 wasCopied:(_Bool)arg15 wasModifiedDuringWrite:(_Bool)arg16;
