...
@class NSDictionary, NSMutableArray, NSObject, NSString, TSKAccessController, TSKAnnotationAuthor, TSKAnnotationAuthorStorage, TSKChangeNotifier, TSKCollaborationCommandHistory, TSKCollaborationDocumentSessionState, TSKCollaborationState, TSKCommandHistory, TSKDocumentSupport, TSKPasteboardController, TSKSelectionDispatcher, TSSStylesheet, TSSTheme, TSULocale, TSUWeakReference;
...
@property(readonly, nonatomic) NSString *redoActionString; // @synthesize redoActionString=_redoActionString;
@property(readonly, nonatomic) NSString *undoActionString; // @synthesize undoActionString=_undoActionString;
@property(readonly, nonatomic) unsigned long long redoCount; // @synthesize redoCount=_redoCount;
@property(readonly, nonatomic) unsigned long long undoCount; // @synthesize undoCount=_undoCount;
@property(readonly, nonatomic) _Bool hasCommands; // @synthesize hasCommands=_hasCommands;
@property(readonly, nonatomic) TSKCommandHistory *commandHistory; // @synthesize commandHistory=_commandHistory;
@property(readonly, nonatomic) TSKCollaborationCommandHistory *collaborationCommandHistory; // @synthesize collaborationCommandHistory=_collaborationCommandHistory;
...
@property(nonatomic) _Bool shouldPreventImageConversionOnOpen; // @synthesize shouldPreventImageConversionOnOpen=_preventImageConversionOnOpen;
