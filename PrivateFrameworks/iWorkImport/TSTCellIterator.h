...
- (void)terminate;
- (_Bool)getNext:(CDStruct_d49748f8 *)arg1;
- (_Bool)p_getData:(CDStruct_d49748f8 *)arg1 forCellID:(struct TSUCellCoord)arg2;
- (void)p_resetIterData:(CDStruct_d49748f8 *)arg1;
- (void)iterateCellsWithBlock:(CDUnknownBlockType)arg1;
- (void)dealloc;
