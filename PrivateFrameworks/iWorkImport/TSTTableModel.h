...
- (void)remapTableUIDsInFormulasWithMap:(const UUIDMap_8a451d2c *)arg1 calcEngine:(id)arg2 bakeForBadRefs:(_Bool)arg3;
...
- (id)regionForValueCellsInRange:(struct TSUCellRect)arg1;
