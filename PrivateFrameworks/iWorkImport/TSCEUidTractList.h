...
- (_Bool)remapUsingColumnUidMap:(const UUIDMap_8a451d2c *)arg1 rowUidMap:(const UUIDMap_8a451d2c *)arg2 clearIfMissing:(_Bool)arg3;
- (_Bool)remapUsingUidMap:(const UUIDMap_8a451d2c *)arg1;
- (id)description;
...
- (void)removeFromExcludedUidsTractRowUids:(const unordered_set_c04cc813 *)arg1;
- (void)removeFromExcludedUidsTractColumnUids:(const unordered_set_c04cc813 *)arg1;
