...
- (void)conference:(AVConference *)arg1 didDisableCaptions:(_Bool)arg2 error:(NSError *)arg3;
- (void)conference:(AVConference *)arg1 didEnableCaptions:(_Bool)arg2 error:(NSError *)arg3;
