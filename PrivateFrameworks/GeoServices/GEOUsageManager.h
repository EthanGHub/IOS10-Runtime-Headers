...
- (void)_captureNetworUsageLogMessageForService:(int)arg1 requestType:(int)arg2 requestErrorDomain:(id)arg3 requestErrorCode:(long long)arg4 requestErrorDescription:(id)arg5 requestDataSize:(int)arg6 responseDataSize:(int)arg7 responseTime:(int)arg8 traits:(id)arg9 fromLogFrameworkAdaptor:(_Bool)arg10;
- (void)_captureNetworUsageLogMessageForRequester:(id)arg1 service:(int)arg2 requestType:(int)arg3 requestErrorDomain:(id)arg4 requestErrorCode:(long long)arg5 requestErrorDescription:(id)arg6 traits:(id)arg7 fromLogFrameworkAdaptor:(_Bool)arg8;
...
- (void)dealloc;
- (id)init;
- (void)captureMapsWidgetsInteractionForType:(int)arg1 endState:(int)arg2 widgetSpecificObject:(id)arg3 wasLocked:(_Bool)arg4 forDuration:(double)arg5;
...
- (void)captureNetworkEventForService:(int)arg1 requestType:(int)arg2 requestErrorDomain:(id)arg3 requestErrorCode:(long long)arg4 requestErrorDescription:(id)arg5 requestDataSize:(int)arg6 responseDataSize:(int)arg7 responseTime:(int)arg8 traits:(id)arg9 fromLogFrameworkAdaptor:(_Bool)arg10;
- (void)captureNetworkEventForRequester:(id)arg1 networkService:(int)arg2 requestType:(int)arg3 requestErrorDomain:(id)arg4 requestErrorCode:(long long)arg5 requestErrorDescription:(id)arg6 traits:(id)arg7 fromLogFrameworkAdaptor:(_Bool)arg8;
