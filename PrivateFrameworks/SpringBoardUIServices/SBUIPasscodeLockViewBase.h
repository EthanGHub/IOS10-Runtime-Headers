...
@class NSString, NSTimer, SBUIPasscodeEntryField, UIColor, _UILegibilitySettings, _UISystemSoundPlayer;
...
@property(retain, nonatomic) _UISystemSoundPlayer *authenticationFeedbackBehavior; // @synthesize authenticationFeedbackBehavior=_authenticationFeedbackBehavior;
...
@property(retain, nonatomic) _UISystemSoundPlayer *keyboardFeedbackBehavior; // @synthesize keyboardFeedbackBehavior=_keyboardFeedbackBehavior;
