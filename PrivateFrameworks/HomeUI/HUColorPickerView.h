...
@class HUColorWheelView, HUQuickControlMagnifierView, HUQuickControlSimpleViewProfile, NSString, UILongPressGestureRecognizer;
...
@interface HUColorPickerView : UIView <UIGestureRecognizerDelegate, HUQuickControlInteractiveView>
{
    ...
    CDStruct_02f6d515 _selectedColorCoordinate;
...
@property(nonatomic) CDStruct_02f6d515 selectedColorCoordinate; // @synthesize selectedColorCoordinate=_selectedColorCoordinate;
