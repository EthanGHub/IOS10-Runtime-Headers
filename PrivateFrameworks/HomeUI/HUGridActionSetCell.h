...
@class HFItem, HUGridSceneCellLayoutOptions, HUIconView, HUPieActivityIndicatorView, NAFuture, NSArray, NSString, UIView, _HUGridActionSetTitleAndDescriptionView;
...
@property(retain, nonatomic) HUPieActivityIndicatorView *activityIndicator; // @synthesize activityIndicator=_activityIndicator;
