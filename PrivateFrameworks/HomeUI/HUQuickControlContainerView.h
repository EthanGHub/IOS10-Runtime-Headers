...
@class HUControlHostView, HUQuickControlAuxiliaryHostView, HUQuickControlButtonRowView, HUQuickControlPillButton, HUQuickControlSummaryView, NSArray, NSLayoutConstraint, UILayoutGuide, _UIBackdropView, _UIBackdropViewSettings;
...
@property(retain, nonatomic) HUQuickControlPillButton *alternateControlButton; // @synthesize alternateControlButton=_alternateControlButton;
@property(retain, nonatomic) HUQuickControlPillButton *detailsButton; // @synthesize detailsButton=_detailsButton;
