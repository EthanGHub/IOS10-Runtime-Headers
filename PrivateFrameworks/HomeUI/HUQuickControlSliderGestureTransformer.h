...
@interface HUQuickControlSliderGestureTransformer : NSObject
{
    ...
    _Bool _hasRecognizedSignificantSliderMovement;
...
@property(nonatomic) _Bool hasRecognizedSignificantSliderMovement; // @synthesize hasRecognizedSignificantSliderMovement=_hasRecognizedSignificantSliderMovement;
