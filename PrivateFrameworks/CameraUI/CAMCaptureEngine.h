...
- (void)captureOutput:(id)arg1 didFinishProcessingLivePhotoToMovieFileAtURL:(id)arg2 withDuration:(CDStruct_1b6d18a9)arg3 photoDisplayTime:(CDStruct_1b6d18a9)arg4 forSettings:(id)arg5 error:(id)arg6;
- (void)captureOutput:(id)arg1 didFinishRecordingLivePhotoMovieForEventualFileAtURL:(id)arg2 settings:(id)arg3;
- (void)captureOutput:(id)arg1 didFinishProcessingOriginalPhotoSurface:(const void *)arg2 ofSize:(unsigned long long)arg3 withPreviewSurface:(const void *)arg4 ofSize:(unsigned long long)arg5 metadata:(id)arg6 forSettings:(id)arg7 error:(id)arg8;
- (void)captureOutput:(id)arg1 didFinishProcessingPhotoSurface:(void *)arg2 ofSize:(unsigned long long)arg3 withPreviewSurface:(void *)arg4 ofSize:(unsigned long long)arg5 metadata:(id)arg6 forSettings:(id)arg7 error:(id)arg8;
- (void)_didFinishProcessingStillImageSurface:(void *)arg1 ofSize:(unsigned long long)arg2 withPreviewSurface:(void *)arg3 ofSize:(unsigned long long)arg4 metadata:(id)arg5 forSettings:(id)arg6 error:(id)arg7;
