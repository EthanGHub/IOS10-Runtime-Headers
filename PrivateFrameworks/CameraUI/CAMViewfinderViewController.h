...
@class CAMAnimationDelegate, CAMBottomBar, CAMBurstIndicatorView, CAMCameraRollController, CAMCaptureGraphConfiguration, CAMClosedViewfinderController, CAMElapsedTimeView, CAMFilterButton, CAMFlashBadge, CAMFlashButton, CAMFlipButton, CAMFocusLockBadge, CAMFramerateIndicatorView, CAMGridView, CAMHDRBadge, CAMHDRButton, CAMIdleController, CAMImageWell, CAMIrisButton, CAMKeepAliveController, CAMLivePhotoBadge, CAMLocationController, CAMLowDiskSpaceAlertView, CAMModeDial, CAMMotionController, CAMPanoramaViewController, CAMPhysicalCaptureRecognizer, CAMPowerController, CAMPreciseTimer, CAMPreviewViewController, CAMRemoteShutterController, CAMShutterIndicatorView, CAMTimelapseController, CAMTimerButton, CAMTimerIndicatorView, CAMTopBar, CAMTorchPatternController, CAMZoomSlider, CUCaptureController, CUShutterButton, NSDate, NSMutableSet, NSSet, NSString, UIAlertView, UIButton, UIGestureRecognizer, UIPanGestureRecognizer, UIPinchGestureRecognizer, UISwipeGestureRecognizer, UIView;
...
@property(nonatomic, setter=_setPreviousLayoutStyle:) long long _previousLayoutStyle; // @synthesize _previousLayoutStyle=__previousLayoutStyle;
...
- (void)_changeToZoomFactor:(double)arg1 shouldAnimate:(_Bool)arg2;
...
- (_Bool)_isZoomAllowedForCurrentModeAndDevice;
