...
{
    _Bool _syncAllowed;
    _Bool _postDAVSyncNotificationWhenUnlocking;
...
@property(nonatomic) _Bool postDAVSyncNotificationWhenUnlocking; // @synthesize postDAVSyncNotificationWhenUnlocking=_postDAVSyncNotificationWhenUnlocking;
