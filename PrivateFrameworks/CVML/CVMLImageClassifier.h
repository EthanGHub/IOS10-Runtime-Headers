...
+ (_Bool)computeImageDescriptorsWithImage:(id)arg1 regionOfInterest:(struct CGRect)arg2 usingDescriptorProcessor:(struct ImageDescriptorProcessorAbstract *)arg3 withTileCount:(int)arg4 andScaleImage:(_Bool)arg5 andPopulateTheBuffer:(struct ImageDescriptorBufferAbstract *)arg6 debugIntermediatesDumpPath:(id)arg7 outputDebugDictionary:(id)arg8 options:(id)arg9 metalContext:(id)arg10 error:(id *)arg11;
