...
@class CVMLSimilarityMatrix, NSArray, NSData, NSDictionary, NSObject, NSSet;
...
- (_Bool)addDescriptorIds:(NSArray *)arg1 withSimilarityMatrix:(CVMLSimilarityMatrix *)arg2 cancellationSemaphore:(NSObject<OS_dispatch_semaphore> *)arg3 error:(id *)arg4;
