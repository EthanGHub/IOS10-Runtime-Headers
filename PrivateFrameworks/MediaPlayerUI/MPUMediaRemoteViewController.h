...
@class MPAVRoutingController, MPUApplicationDefaults, MPUMediaRemoteControlsView, MPUNowPlayingController, MPUSupportedRemoteControls, MPUTransportControlMediaRemoteController, NSArray, NSString, NSTimer;

@interface MPUMediaRemoteViewController : UIViewController <MPAVRoutingControllerDelegate, MPUChronologicalProgressViewDelegate, MPUTransportControlsViewDelegate, MPUTransportControlMediaRemoteControllerDelegate, MPUNowPlayingDelegate, MPUTransportControlsViewDataSource, MPUTransportControlsViewLayoutDelegate>
{
