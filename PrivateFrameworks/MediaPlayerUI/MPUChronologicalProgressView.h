...
@class MPDetailScrubController, MPUNowPlayingIndicatorView, MPUTimeFormatter, NSString, UILabel, UISlider;
...
@property(retain, nonatomic) MPUTimeFormatter *timeFormatter; // @synthesize timeFormatter=_timeFormatter;
