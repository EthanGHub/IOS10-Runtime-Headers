...
@property(nonatomic, getter=isNameSourceAuto) _Bool nameSourceAuto;
@property(nonatomic, getter=isRepresentativeFace) _Bool representativeFace;
@property(nonatomic, getter=isHiddenInGroups) _Bool isHiddenInGroups;
