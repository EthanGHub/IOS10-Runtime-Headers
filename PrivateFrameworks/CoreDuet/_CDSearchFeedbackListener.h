...
{
    _Bool _isSpotlight;
    _Bool _didSuggestQueryForSession;
    _Bool _didRenderInformationalResults;
...
@property(nonatomic) _Bool didRenderInformationalResults; // @synthesize didRenderInformationalResults=_didRenderInformationalResults;
@property(nonatomic) _Bool didSuggestQueryForSession; // @synthesize didSuggestQueryForSession=_didSuggestQueryForSession;
...
- (_Bool)_resultIsPunchout:(id)arg1;
