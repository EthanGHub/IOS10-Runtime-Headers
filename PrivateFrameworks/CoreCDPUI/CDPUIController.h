...
@interface CDPUIController : CDPUIBaseController <CDPWaitingApprovalDelegate, KeychainSyncViewControllerDelegate, CDPDevicePickerDelegate, CDPRemoteSecretEntryDelegate>
{
    NSArray *_devices;
