...
@class MPWeakTimer, MusicSimpleRadioStationInfo, NSArray, NSIndexPath, NSString, RURadioDataSource, UIActivityIndicatorView, UINavigationController, UIView;

@interface MCDRadioViewController : MCD_OLD_TableViewController <MCDRadioContentManagerDelegate, MCDErrorViewDelegate, RURadioDataSourceDelegate>
{
