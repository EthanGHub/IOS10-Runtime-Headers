...
@class MCDPlayModeControlView, MCDProgressView, MCDTitleView, MCDTransportControlView, UIColor, UIFocusContainerGuide, UIImageView, UILabel, UILongPressGestureRecognizer, UITapGestureRecognizer;
