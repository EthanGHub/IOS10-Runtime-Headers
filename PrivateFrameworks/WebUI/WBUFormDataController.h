...
- (void)gatherAutoFillDisplayDataWithFormMetadata:(id)arg1 multiRoundAutoFillManager:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)gatherAutoFillDisplayDataWithTextField:(id)arg1 wantCascadingAddressMatches:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;
