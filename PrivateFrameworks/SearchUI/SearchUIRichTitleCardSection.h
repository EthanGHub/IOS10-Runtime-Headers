...
#import <SearchUI/SearchUIRichTitleCardSection-Protocol.h>
...
@property(copy, nonatomic) NSString *contentRatingText; // @synthesize contentRatingText=_contentRatingText;
