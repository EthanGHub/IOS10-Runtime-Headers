...
@class BRCALRowID, BRCAccountSession, BRCClientZone, BRCFSEventsMonitor, BRCPQLConnection, BRCPrivateAppLibrary, BRCRelativePath, BRCSharedAppLibrary, BRCSyncContext, BRCZoneRowID, NSMutableDictionary, NSMutableIndexSet, NSMutableSet, NSNumber, NSString, NSURL;
...
- (_Bool)markChildrenLostForItemID:(id)arg1;
- (void)continueMarkingChildrenLost;
- (_Bool)markChildrenLostForItemID:(id)arg1 startingFromRow:(unsigned long long)arg2 hasMoreWork:(_Bool *)arg3;
...
- (id)initWithName:(id)arg1 ownerName:(id)arg2 dbRowID:(id)arg3 zoneRowID:(id)arg4 db:(id)arg5 plist:(id)arg6 session:(id)arg7 initialCreation:(_Bool)arg8;
- (id)init;
