...
- (_Bool)_saveEditedShareRecords:(id)arg1 syncStatus:(long long)arg2;
...
- (_Bool)_saveEditedShareRecord:(id)arg1;
- (void)_learnIdentityForShare:(id)arg1;
- (_Bool)_saveEditedAliasRecord:(id)arg1;
- (_Bool)_saveEditedFinderBookmarkRecord:(id)arg1;
- (_Bool)_saveEditedSymlinkRecord:(id)arg1;
