...
- (_Bool)createSharedAppLibraryOnDiskWithMangledID:(id)arg1 createdRoot:(_Bool *)arg2;
- (_Bool)createAppLibraryOnDisk:(id)arg1 createdRoot:(_Bool *)arg2 createdDocuments:(_Bool *)arg3;
...
- (id)getOrCreatePrivateAppLibrary:(id)arg1 withRowID:(id)arg2 onDisk:(_Bool)arg3 withExistingClientZone:(id)arg4;
- (id)_getOrCreateAppLibraryAndZonesIfNecessary:(id)arg1 ownerName:(id)arg2 alreadyExistsAndResumed:(_Bool *)arg3;
- (void)__registerServerZone:(id)arg1 clientZone:(id)arg2 appLibrary:(id)arg3 isShared:(_Bool)arg4;
- (id)__getOrCreateAppLibrary:(id)arg1 ownerName:(id)arg2 rowID:(id)arg3 createOnDisk:(_Bool)arg4 alreadyExistsAndResumed:(_Bool *)arg5 zoneID:(id)arg6 withClientZone:(id)arg7;
...
- (_Bool)_recursivelyPrepareFolderForLogOutAtURL:(id)arg1 pruneEmptyFolders:(_Bool)arg2 maxDepth:(unsigned long long)arg3;
