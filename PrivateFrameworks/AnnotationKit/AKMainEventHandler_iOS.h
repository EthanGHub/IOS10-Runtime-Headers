...
@class AKPanGestureRecognizer, NSString, NSTimer, UILongPressGestureRecognizer, UIRotationGestureRecognizer, UITapGestureRecognizer;
...
@property(retain) NSTimer *penDrawingTimer; // @synthesize penDrawingTimer=_penDrawingTimer;
