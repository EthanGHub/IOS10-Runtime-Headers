...
@class CKBrowserDragViewController, CKPresentationControllerWindow, NSString, UILongPressGestureRecognizer, UIView;
...
@property(retain, nonatomic) CKPresentationControllerWindow *dragWindow; // @synthesize dragWindow=_dragWindow;
