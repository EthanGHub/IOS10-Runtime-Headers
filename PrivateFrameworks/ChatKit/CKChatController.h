...
@property(retain, nonatomic) CKSuggestionsProxy *suggestionsProxy; // @synthesize suggestionsProxy=_suggestionsProxy;
...
- (void)fullScreenBalloonViewController:(id)arg1 didDisappearWithSendAnimation:(_Bool)arg2;
...
- (_Bool)transcriptCollectionViewController:(id)arg1 shouldCleanupFinishedFullscreenEffect:(id)arg2;
- (_Bool)transcriptCollectionViewController:(id)arg1 shouldStartFullscreenEffect:(id)arg2;
