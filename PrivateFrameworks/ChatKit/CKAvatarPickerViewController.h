...
@class CKAvatarPickerLayout, CKAvatarTitleCollectionReusableView, CKConversation, NSString, UICollectionView, UITapGestureRecognizer;
@protocol CKAvatarPickerViewControllerDelegate;

@interface CKAvatarPickerViewController : UIViewController <UICollectionViewDelegate, UICollectionViewDataSource, CNAvatarViewDelegate>
{
