...
@class CABackdropLayer, CKInvisibleInkEffectController, CKManualUpdater, NSMutableArray, NSString, UIColor, UIImage, UILongPressGestureRecognizer, UITapGestureRecognizer;
...
@property(nonatomic) _Bool invisibleInkEffectPaused; // @dynamic invisibleInkEffectPaused;
