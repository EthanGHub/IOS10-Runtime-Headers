...
#import <ChatKit/CKEditMembersViewControllerDelegate-Protocol.h>
#import <ChatKit/CKRecipientSelectionControllerDelegate-Protocol.h>

@class CKEditMembersViewController, NSString, UIBarButtonItem;

@interface CKGroupRecipientSelectionController : CKRecipientSelectionController <CKRecipientSelectionControllerDelegate, CKEditMembersViewControllerDelegate>
{
    UIBarButtonItem *_doneButton;
    CKEditMembersViewController *_editMembersViewController;
}

@property(retain, nonatomic) CKEditMembersViewController *editMembersViewController; // @synthesize editMembersViewController=_editMembersViewController;
