...
@class CKMessageEntryViewLayoutMetrics, CKUITheme, NSArray, NSAttributedString, NSDateFormatter, NSDictionary, NSString, UIFont, UIImage;
...
- (struct CGSize)stickerSizeScaledWithInitialSize:(struct CGSize)arg1 imageScale:(double)arg2 userScale:(double)arg3 rectifiedScreenScale:(double)arg4;
...
@property(readonly, nonatomic) NSString *aggregateAcknowledgmentStackName;
...
@property(readonly, nonatomic) NSString *aggregateAcknowledgmentStackBackgroundName;
...
@property(readonly, nonatomic) NSArray *avatarPancakeOffsets;
...
- (double)balloonMaxWidthForTranscriptWidth:(double)arg1 marginInsets:(struct UIEdgeInsets)arg2 shouldShowPhotoButton:(_Bool)arg3 shouldShowCharacterCount:(_Bool)arg4 shouldCoverSendButton:(_Bool)arg5;
