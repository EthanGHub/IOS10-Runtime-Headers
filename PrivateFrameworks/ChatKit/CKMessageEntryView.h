...
@class CAMShutterButton, CKActionMenuController, CKActionMenuGestureRecognizerButton, CKAudioRecorder, CKComposition, CKConversation, CKInlineAudioReplyButtonController, CKMessageEntryAudioHintView, CKMessageEntryContentView, CKMessageEntryRecordedAudioView, CKMessageEntryWaveformView, CKScheduledUpdater, NSArray, NSString, UIButton, UILabel, UILongPressGestureRecognizer, UIPreviewInteraction, _UIBackdropView;
...
@interface CKMessageEntryView : UIView <CKMessageEntryContentViewDelegate, CKAudioRecorderDelegate, CKActionMenuControllerDelegate, CKMessageEntryRecordedAudioViewDelegate, CKActionMenuGestureRecognizerButtonDelegate, CKInlineAudioReplyButtonDelegate, UIGestureRecognizerDelegate, _UIBackdropViewGraphicsQualityChangeDelegate, CKMessageEntryViewStyleProtocol>
{
    ...
    _Bool _disabledCalloutOnFirstTap;
    _Bool _entryFieldUpdaterCollapsedValue;
    _Bool _entryFieldUpdaterAnimatedValue;
    _Bool _entryFieldUpdaterDisableCalloutsValue;
...
+ (id)audioButtonImage;
+ (struct UIEdgeInsets)contentViewInsetsForMarginInsets:(struct UIEdgeInsets)arg1 shouldShowPhotoButton:(_Bool)arg2 shouldShowCharacterCount:(_Bool)arg3 shouldCoverSendButton:(_Bool)arg4;
...
@property(nonatomic) _Bool entryFieldUpdaterDisableCalloutsValue; // @synthesize entryFieldUpdaterDisableCalloutsValue=_entryFieldUpdaterDisableCalloutsValue;
...
@property(nonatomic) _Bool disabledCalloutOnFirstTap; // @synthesize disabledCalloutOnFirstTap=_disabledCalloutOnFirstTap;
...
@property(retain, nonatomic) UIButton *digitalTouchButton; // @synthesize digitalTouchButton=_digitalTouchButton;
...
- (void)_updateEntryView:(_Bool)arg1 disableCallouts:(_Bool)arg2;
- (void)updateEntryView:(_Bool)arg1;
...
- (void)setEntryFieldCollapsed:(_Bool)arg1 animated:(_Bool)arg2 disableCallouts:(_Bool)arg3;
...
- (id)initWithFrame:(struct CGRect)arg1 marginInsets:(struct UIEdgeInsets)arg2 shouldAllowImpact:(_Bool)arg3 shouldShowSendButton:(_Bool)arg4 shouldShowSubject:(_Bool)arg5 shouldShowPhotoButton:(_Bool)arg6 shouldShowCharacterCount:(_Bool)arg7;
