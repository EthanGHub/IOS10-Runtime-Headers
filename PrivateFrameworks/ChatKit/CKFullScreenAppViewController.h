...
@property(readonly, nonatomic) UIView *iavOverride;
...
- (void)animateBrowserViewToTargetRect:(struct CGRect)arg1 completion:(CDUnknownBlockType)arg2;
- (void)animateBrowserViewFromSourceRect:(struct CGRect)arg1 interactive:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
