...
- (void)enqueueText:(id)arg1 isPhonetic:(_Bool)arg2 provisionally:(_Bool)arg3 eligibleAfterDuration:(double)arg4 preparationIdentifier:(id)arg5 completion:(CDUnknownBlockType)arg6 animationIdentifier:(id)arg7;
