...
- (void)siriRemoteViewController:(AFUISiriRemoteViewController *)arg1 canLoadPreviousConversation:(void (^)(_Bool))arg2;
...
- (void)siriRemoteViewController:(AFUISiriRemoteViewController *)arg1 launchApplicationWithBundleIdentifier:(NSString *)arg2 withURL:(NSURL *)arg3 launchOverSiri:(_Bool)arg4 replyHandler:(void (^)(_Bool))arg5;
