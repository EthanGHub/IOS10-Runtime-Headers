...
- (id)description;
- (id)init;
- (id)initWithText:(id)arg1 provisional:(_Bool)arg2 eligibleAfterDuration:(double)arg3 preparation:(CDUnknownBlockType)arg4 completion:(CDUnknownBlockType)arg5 animationIdentifier:(id)arg6;
