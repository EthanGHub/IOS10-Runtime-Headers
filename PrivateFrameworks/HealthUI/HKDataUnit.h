...
@property(readonly, nonatomic) unsigned long long associatedSampleStatisticsOptions; // @synthesize associatedSampleStatisticsOptions=_associatedSampleStatisticsOptions;
