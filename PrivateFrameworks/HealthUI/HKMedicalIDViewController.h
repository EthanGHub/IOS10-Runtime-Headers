...
@interface HKMedicalIDViewController : HKViewController <UITableViewDataSource, UITableViewDelegate, HKMedicalIDViewControllerDelegate, HKEmergencyCardDeletionDelegate, HKEmergencyCardRowHeightChangeDelegate>
{
    NSArray *_tableItems;
...
- (id)initInEditMode:(_Bool)arg1 inBuddy:(_Bool)arg2;
