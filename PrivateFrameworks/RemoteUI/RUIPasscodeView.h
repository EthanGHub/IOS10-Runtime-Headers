...
@class NSString, PSPasscodeField, RUIObjectModel, RUIPage, UIColor, UITextField, UIView;
@protocol RUIHeader, RemoteUITableFooter;

@interface RUIPasscodeView : RUIElement <RUITableFooterDelegate, PSPasscodeFieldDelegate, RUITopLevelPageElement>
{
