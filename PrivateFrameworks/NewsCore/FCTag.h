...
@class FCAssetHandle, FCHeadlineTemplate, FCInterestToken, FCTagBanner, FCTextInfo, NSArray, NSData, NSString, NTPBFeedConfiguration, NTPBTagRecord, UIColor;
...
- (id)_feedIDForBin:(long long)arg1 paid:(_Bool)arg2;
