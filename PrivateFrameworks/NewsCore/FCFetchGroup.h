...
@property(readonly, nonatomic) long long networkPriority; // @synthesize networkPriority=_networkPriority;
...
- (void)fireCompletion;
- (id)initWithKeys:(id)arg1 context:(id)arg2 shouldFilter:(_Bool)arg3 qualityOfService:(long long)arg4 networkPriority:(long long)arg5 completionQueue:(id)arg6 completion:(CDUnknownBlockType)arg7;
