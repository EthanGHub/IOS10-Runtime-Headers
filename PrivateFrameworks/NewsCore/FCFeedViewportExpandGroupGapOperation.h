...
@class FCCloudContext, FCDateRange, FCFeedDescriptor, FCFeedGroup, FCFeedViewport, FCFeedViewportGap, FCForYouCatchUpOperation, NSArray, NSDictionary, NSError;
...
@property(retain, nonatomic) FCForYouCatchUpOperation *forYouCatchUpOperation; // @synthesize forYouCatchUpOperation=_forYouCatchUpOperation;
...
- (_Bool)_reachedEndOfGap:(id)arg1 internalElements:(id)arg2;
