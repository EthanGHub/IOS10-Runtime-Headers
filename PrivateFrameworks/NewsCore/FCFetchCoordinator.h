...
@property(retain, nonatomic) id <FCOperationThrottler> fetchThrottler; // @synthesize fetchThrottler=_fetchThrottler;
...
- (id)fetchKeysUnconditionally:(id)arg1 context:(id)arg2 qualityOfService:(long long)arg3 networkPriority:(long long)arg4 completionQueue:(id)arg5 completion:(CDUnknownBlockType)arg6;
- (id)fetchKeys:(id)arg1 context:(id)arg2 qualityOfService:(long long)arg3 networkPriority:(long long)arg4 completionQueue:(id)arg5 completion:(CDUnknownBlockType)arg6;
