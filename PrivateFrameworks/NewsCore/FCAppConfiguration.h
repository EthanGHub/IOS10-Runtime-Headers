...
@class FCAsyncSerialQueue, FCCoverArticlesConfiguration, FCIAdConfiguration, FCNotificationsConfiguration, FCPrefetchConfiguration, FCRecommendedCategory, FCResource, FCTopStoriesConfiguration, NSArray, NSDictionary, NSHashTable, NSMutableArray, NSString, NTPBPersonalizationConfig;
