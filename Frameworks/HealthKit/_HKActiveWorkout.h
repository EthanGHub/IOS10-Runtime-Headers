...
@class HKLocationSeriesSample, NSData, NSDate, NSDictionary, NSMutableData, NSMutableDictionary, NSObject, NSString;
...
@property(retain, nonatomic) HKLocationSeriesSample *locationSeriesSample; // @synthesize locationSeriesSample=_locationSeriesSample;
- (void).cxx_destruct;
