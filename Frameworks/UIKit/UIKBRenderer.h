...
+ (struct CGContext *)imageContextWithSize:(struct CGSize)arg1 scale:(double)arg2 usesRGBColor:(_Bool)arg3 opaque:(_Bool)arg4 invert:(_Bool)arg5;
...
- (void)ensureContext;
- (void)setDisableRGBColor:(_Bool)arg1;
- (id)description;
- (void)dealloc;
