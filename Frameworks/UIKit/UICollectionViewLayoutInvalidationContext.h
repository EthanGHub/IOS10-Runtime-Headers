...
@interface UICollectionViewLayoutInvalidationContext : NSObject
{
    ...
    _Bool _initiatedFromBoundsChange;
}

@property(nonatomic, getter=_initiatedFromBoundsChange, setter=_setInitiatedFromBoundsChange:) _Bool initiatedFromBoundsChange; // @synthesize initiatedFromBoundsChange=_initiatedFromBoundsChange;
