...
+ (CDStruct_8ff2893d *)getStatusBarOverrideData;
+ (const CDStruct_5e10f1a5 *)getStatusBarData;
+ (void)permanentizeStatusBarOverrideData;
+ (void)postStatusBarOverrideData:(CDStruct_8ff2893d *)arg1;
...
+ (void)postStatusBarData:(const CDStruct_5e10f1a5 *)arg1 withActions:(int)arg2;
...
- (void)_receivedStatusBarData:(CDStruct_5e10f1a5 *)arg1 actions:(int)arg2;
- (void)dealloc;
