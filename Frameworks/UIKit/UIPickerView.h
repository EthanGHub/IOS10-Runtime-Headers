...
@class CALayer, NSMutableArray, NSString, UIColor, UIImageView, _UIPickerViewTestParameters, _UISystemSoundPlayer;
...
@property(retain, nonatomic, getter=_retargetBehavior, setter=_setRetargetBehavior:) _UISystemSoundPlayer *retargetBehavior; // @synthesize retargetBehavior=_retargetBehavior;
