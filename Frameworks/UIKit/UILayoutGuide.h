...
@class NSArray, NSISVariable, NSLayoutDimension, NSLayoutXAxisAnchor, NSLayoutYAxisAnchor, NSMutableSet, NSString, UIView;
...
@property(readonly, retain, nonatomic) NSMutableSet *_stashedLayoutVariableObservations; // @synthesize _stashedLayoutVariableObservations;
