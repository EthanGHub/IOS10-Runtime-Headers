...
@class NSArray, NSMapTable, NSMutableDictionary, NSTimer, UIView, _UIKBRTDecayingObject, _UIKBRTDecayingOffset, _UIKBRTTouchHistory, _UIKBRTTouchHistoryInfo;
...
@interface _UIKBRTTouchDrifting : _UIKBRTKeyboardTouchObserver
{
    ...
    _Bool _leftDriftLocked;
    _Bool _rightDriftLocked;
...
@property(nonatomic) _Bool rightDriftLocked; // @synthesize rightDriftLocked=_rightDriftLocked;
...
@property(nonatomic) _Bool leftDriftLocked; // @synthesize leftDriftLocked=_leftDriftLocked;
...
@property(nonatomic) struct CGSize touchError; // @synthesize touchError=_touchError;
