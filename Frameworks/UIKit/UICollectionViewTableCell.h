...
@class NSArray, NSString, UICollectionViewLayout, UICollectionViewTableLayout, UICollectionViewTableLayoutAttributes, UIColor, UIImageView, UILabel, UIScrollView, UITableViewCell, UITableViewCollectionCell, UIView;
...
@interface UICollectionViewTableCell : UICollectionViewCell <UITable_UITableViewCellDelegate>
{
    ...
    _Bool _editing;
    struct CGPoint _reorderingCenter;
