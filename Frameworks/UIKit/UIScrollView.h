...
#import <UIKit/UIRefreshControlHosting-Protocol.h>
#import <UIKit/UIScrollViewDelayedTouchesBeganGestureRecognizerClient-Protocol.h>
#import <UIKit/_UIScrollToTopView-Protocol.h>

@class NSArray, NSISVariable, NSString, UIGestureRecognizer, UIImageView, UIPanGestureRecognizer, UIPinchGestureRecognizer, UIRefreshControl, UIScrollViewDirectionalPressGestureRecognizer, UIScrollViewPinchGestureRecognizer, UISwipeGestureRecognizer, _UIStaticScrollBar;
@protocol UIScrollViewDelegate, _UIScrollViewLayoutObserver;

@interface UIScrollView : UIView <UIGestureRecognizerDelegate, UIScrollViewDelayedTouchesBeganGestureRecognizerClient, _UIScrollToTopView, NSCoding, UIRefreshControlHosting>
{
    id _delegate;
