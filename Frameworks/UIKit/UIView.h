...
@class CALayer, NSArray, NSISEngine, NSISVariable, NSLayoutDimension, NSLayoutXAxisAnchor, NSLayoutYAxisAnchor, NSMutableArray, NSMutableSet, NSString, UIBezierPath, UIColor, UIKBRenderConfig, UILayoutGuide, UIPresentationController, UIStoryboardPreviewingSegueTemplateStorage, UITraitCollection, UIViewController, UIWindow, _UITouchForceObservable;
@protocol UIFocusContainer, UIFocusEnvironment, _UIFocusRegionContainer;
...
@property(readonly, nonatomic) NSMutableSet *_stashedLayoutVariableObservations; // @synthesize _stashedLayoutVariableObservations;
...
- (void)_testIsDescendantForFirstView:(id)arg1 secondView:(id)arg2 isDecendantResults:(_Bool [2])arg3;
