...
@class NSArray, NSIndexPath, NSMutableArray, NSSet, NSString, UICollectionViewTableCell, UICollectionViewTableLayoutSwipeActionPullView, UIColor, UIGobblerGestureRecognizer, UIPanGestureRecognizer, UIScrollView, UITableViewRowData, UIView, UIVisualEffect, _UISwipableTableViewCellDeleteScanlineView;
...
- (_Bool)_shouldHaveViewForElementOfKind:(id)arg1 atSection:(long long)arg2;
