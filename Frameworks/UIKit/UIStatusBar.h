...
@interface UIStatusBar : _UIScrollsToTopInitiatorView <UIStatusBarServerClient, UIStatusBarStateObserver>
{
    ...
    CDStruct_5e10f1a5 _currentRawData;
    ...
    CDStruct_8ff2893d *_localDataOverrides;
    UIColor *_tintColor;
...
+ (void)getData:(CDStruct_5e10f1a5 *)arg1 forRequestedData:(const CDStruct_5e10f1a5 *)arg2 withOverrides:(const CDStruct_8ff2893d *)arg3;
...
- (void)statusBarServer:(id)arg1 didReceiveStatusBarData:(const CDStruct_5e10f1a5 *)arg2 withActions:(int)arg3;
...
- (void)setLocalDataOverrides:(CDStruct_8ff2893d *)arg1;
...
- (void)forceUpdateToData:(const CDStruct_5e10f1a5 *)arg1 animated:(_Bool)arg2;
