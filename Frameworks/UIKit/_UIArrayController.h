...
@interface _UIArrayController : NSObject
{
    ...
    _Bool _invalidated;
    _Bool _includeFullStateInChanges;
...
@property(nonatomic, getter=_includeFullStateInChanges, setter=_setIncludeFullStateInChanges:) _Bool _includeFullStateInChanges; // @synthesize _includeFullStateInChanges;
- (void).cxx_destruct;
