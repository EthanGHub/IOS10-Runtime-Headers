...
@property(retain, nonatomic) UITraitCollection *containingResponderTraitCollection; // @synthesize containingResponderTraitCollection=_containingResponderTraitCollection;
