...
@class ADAdActionPublicAttributes, ADAdImpressionPublicAttributes, ADAdSpaceConfiguration, ADAdSpaceRemoteViewController, ADPrivacyViewController, NSDictionary, NSSet, NSString, NSURL, UIImageView, _ADRemoteViewController, _UIAsyncInvocation;
@protocol ADAdRecipient, ADSAdSpace_RPC><NSObject;

@interface ADAdSpace : NSObject <UIViewControllerTransitioningDelegate, ADAdSpace_RPC, ADAdSpaceRemoteViewControllerDelegate, ADPrivacyViewControllerInternalDelegate>
{
