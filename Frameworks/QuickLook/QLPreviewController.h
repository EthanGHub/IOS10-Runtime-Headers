...
@class NSArray, NSMutableArray, NSMutableDictionary, NSString, QLActivityItemProvider, QLBarButtonItem, QLErrorView, QLItem, QLNavigationState, QLPinchRotationTracker, QLPreviewItemStore, QLStateManager, QLSwipeDownTracker, QLToolbarController, QLTransitionController, UIDocumentInteractionController, UINavigationController, UIPanGestureRecognizer, UIPinchGestureRecognizer, UIRotationGestureRecognizer;
...
@interface QLPreviewController : UIViewController <UIGestureRecognizerDelegate, QLPreviewItemProvider, QLPreviewControllerStateProtocol, UIPageViewControllerDelegate, UIViewControllerTransitioningDelegate, UINavigationControllerDelegate, UIScrollViewDelegate>
{
