...
- (void).cxx_destruct;
- (shared_ptr_889ae36a)propertiesQueryForPropertySet:(id)arg1 sortDescriptors:(id)arg2 scopedContainers:(id)arg3 allowedItemIdentifiers:(id)arg4 predicate:(shared_ptr_cf7b8a22)arg5;
- (shared_ptr_e2fca368)entityQueryForPropertySet:(id)arg1 sortDescriptors:(id)arg2 context:(id)arg3 predicate:(shared_ptr_cf7b8a22)arg4;
...
- (map_041e1ed5)_propertyMapForKeyPath:(id)arg1 includePropertiesToSort:(_Bool)arg2;
