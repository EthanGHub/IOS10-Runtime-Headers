...
@property(nonatomic, setter=_setShouldUseStreamingRedownload:) _Bool shouldUseStreamingRedownload; // @synthesize shouldUseStreamingRedownload=_shouldUseStreamingRedownload;
@property(nonatomic, setter=_setPrefersHLS:) _Bool prefersHLS; // @synthesize prefersHLS=_prefersHLS;
