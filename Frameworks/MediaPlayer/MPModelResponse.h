...
@class MPModelRequest, MPPropertySet, MPSectionedCollection, MPStoreLibraryPersonalizationResponseInvalidationToken;
...
- (id)init;
@property(retain, nonatomic) MPStoreLibraryPersonalizationResponseInvalidationToken *personalizationResponseInvalidationToken;
- (id)personalization_newOperationForDetailedKeepLocalStatusConfigurationForSectionAtIndex:(long long)arg1 responseHandler:(CDUnknownBlockType)arg2;
