...
@property(retain, nonatomic) NSObject<OS_dispatch_queue> *keyBagLockStatusChangedQueue; // @synthesize keyBagLockStatusChangedQueue=_keyBagLockStatusChangedQueue;
