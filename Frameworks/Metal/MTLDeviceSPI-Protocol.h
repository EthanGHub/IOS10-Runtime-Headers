...
@class MTLCommandQueueDescriptor, MTLComputePipelineDescriptor, NSArray, NSObject, NSString;
@protocol MTLCommandQueue, MTLComputePipelineState, MTLFunction, OS_dispatch_data;
