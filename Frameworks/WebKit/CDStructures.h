...
struct PostLayoutData {
    ...
    struct Vector<WebCore::SelectionRect, 0, WTF::CrashOnOverflow, 16> _field8;
...
struct RemoteLayerTreeDrawingAreaProxy {
    ...
    struct RetainPtr<WKOneShotDisplayLinkHandler> _field18;
};
...
struct ResourceResponse {
    ...
    struct ParsedContentRange _field17;
    struct CacheControlDirectives _field18;
    _Bool _field19;
    _Bool _field20;
    _Bool _field21;
    _Bool _field22;
    ...
    unsigned int :3;
    unsigned int :1;
    struct RetainPtr<NSURLResponse> _field26;
};
...
struct WebPage {
    ...
    struct RefPtr<WebKit::WebPlaybackSessionManager> _field57;
    ...
    struct Ref<WebKit::WebUserContentController> _field63;
    ...
    struct duration<long long, std::__1::ratio<1, 1000>> _field102;
    struct FloatSize _field103;
    struct FloatSize _field104;
    struct RefPtr<WebCore::Range> _field105;
    struct RefPtr<WebCore::Range> _field106;
    struct IntSize _field107;
    struct FloatSize _field108;
    int _field109;
    _Bool _field110;
    struct HashMap<std::__1::pair<WebCore::IntSize, double>, WebCore::IntPoint, WTF::PairHash<WebCore::IntSize, double>, WTF::HashTraits<std::__1::pair<WebCore::IntSize, double>>, WTF::HashTraits<WebCore::IntPoint>> _field111;
    struct RefPtr<WebCore::Node> _field112;
    struct FloatPoint _field113;
    struct FloatRect _field114;
    struct Timer _field115;
    struct Vector<std::__1::function<void ()>, 0, WTF::CrashOnOverflow, 16> _field116;
    struct HashSet<WTF::String, WTF::ASCIICaseInsensitiveHash, WTF::HashTraits<WTF::String>> _field117;
    struct Color _field118;
    struct HashSet<unsigned int, WTF::IntHash<unsigned int>, WTF::HashTraits<unsigned int>> _field119;
    unsigned int _field120;
    int _field121;
    struct Optional<WebCore::ScrollbarOverlayStyle> _field122;
    _Bool _field123;
    unsigned int _field124;
    unsigned int _field125;
    _Bool _field126;
    struct UserActivity _field127;
    unsigned long long _field128;
    int _field129;
    _Bool _field130;
    _Bool _field131;
    _Bool _field132;
    struct time_point<std::__1::chrono::system_clock, std::__1::chrono::duration<long long, std::__1::ratio<1, 1000000>>> _field133;
};
...
struct WebPageProxy {
    ...
    struct Ref<WebKit::WebBackForwardList> _field68;
    _Bool _field69;
    ...
    _Bool _field99;
    _Bool _field100;
    struct ResourceRequest *_field101;
    _Bool _field102;
    int _field103;
    struct DownloadID _field104;
    _Bool _field105;
    _Bool _field106;
    int _field107;
    struct DownloadID _field108;
    _Bool _field109;
    ...
    _Bool _field167;
    struct RefPtr<WTF::RefCounter<WebKit::UserObservablePageCounterType>::Count> _field168;
    struct RefPtr<WTF::RefCounter<WebKit::ProcessSuppressionDisabledCounterType>::Count> _field169;
    struct RefPtr<WTF::RefCounter<WebKit::HiddenPageThrottlingAutoIncreasesCounterType>::Count> _field170;
    int _field171;
    struct Optional<WebCore::ScrollbarOverlayStyle> _field172;
    unsigned long long _field173;
    struct HashMap<WTF::String, WebKit::WebPreferencesStore::Value, WTF::StringHash, WTF::HashTraits<WTF::String>, WTF::HashTraits<WebKit::WebPreferencesStore::Value>> _field174;
    unsigned int _field175;
    _Bool _field176;
    struct Vector<unsigned long long, 0, WTF::CrashOnOverflow, 16> _field177;
    unsigned int _field178;
    _Bool _field179;
    _Bool _field180;
    struct unique_ptr<WebKit::NodeAssistanceArguments, std::__1::default_delete<WebKit::NodeAssistanceArguments>> _field181;
    _Bool _field182;
};
