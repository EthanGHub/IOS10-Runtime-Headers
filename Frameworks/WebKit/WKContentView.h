...
- (void)didUpdateVisibleRect:(struct CGRect)arg1 unobscuredRect:(struct CGRect)arg2 unobscuredRectInScrollViewCoordinates:(struct CGRect)arg3 obscuredInset:(struct CGSize)arg4 scale:(double)arg5 minimumScale:(double)arg6 inStableState:(_Bool)arg7 isChangingObscuredInsetsInteractively:(_Bool)arg8 enclosedInScrollableAncestorView:(_Bool)arg9;
