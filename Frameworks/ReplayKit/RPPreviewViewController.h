...
+ (void)loadPreviewViewControllerWithMovieURL:(id)arg1 attachmentURL:(id)arg2 overrideShareMessage:(id)arg3 darkToolbar:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;
