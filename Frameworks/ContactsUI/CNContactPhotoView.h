...
@class CNAvatarView, CNMutableContact, NSArray, NSString, PRLikeness, UIButton, UIImageView, UILongPressGestureRecognizer, _CNUIPRLikenessResolver;
...
@property(retain, nonatomic) _CNUIPRLikenessResolver *likenessResolver; // @synthesize likenessResolver=_likenessResolver;
