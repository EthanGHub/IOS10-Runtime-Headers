...
@class MKMapItem, MKNearestStationViewController, MKPlaceCardActionItem, MKPlaceCardActionsViewController, MKPlaceCardHeaderViewController, NSMutableArray, NSNumber, NSString;
