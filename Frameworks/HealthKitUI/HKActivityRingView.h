...
@interface HKActivityRingView : UIView
{
    ...
    _Bool _alwaysRequireDisplayLink;
    HKActivitySummary *_activitySummary;
    double _ringInsetPercentage;
}

+ (id)_iconSpriteImage;
@property(nonatomic, getter=_alwaysRequireDisplayLink, setter=_setAlwaysRequireDisplayLink:) _Bool alwaysRequireDisplayLink; // @synthesize alwaysRequireDisplayLink=_alwaysRequireDisplayLink;
