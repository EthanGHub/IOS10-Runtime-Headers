...
@class HMAccessory, HMApplicationData, HMBulletinBoardNotification, HMDelegateCaller, HMFMessageDispatcher, HMThreadSafeMutableArrayCollection, NSArray, NSNumber, NSString, NSUUID;
