...
@class NSArray, NSMutableDictionary, NSString, NSURL, SFBrowserRemoteViewController, SFInteractiveDismissController, SFSafariViewControllerConfiguration, UIColor, _SFQueueingBrowserServiceViewControllerProxy, _UIAsyncInvocation, _WKActivatedElementInfo;
...
@property(readonly, copy, nonatomic) SFSafariViewControllerConfiguration *configuration; // @synthesize configuration=_configuration;
- (void).cxx_destruct;
...
@property(retain, nonatomic, setter=_setPreferredBarTintColor:) UIColor *_preferredBarTintColor;
