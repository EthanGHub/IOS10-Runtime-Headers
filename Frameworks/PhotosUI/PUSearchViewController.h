...
@class NSString, PHCachingImageManager, PSIDatabase, PUPingTimer, PUSearchResultsDataSource, PUSuggestedSearchResultsDataSource, UIBarButtonItem, UISearchBar, UITableView, UIView;
...
- (void)_pushMomentsGridForPhotosWithUUIDs:(id)arg1 title:(id)arg2 animated:(_Bool)arg3;
