...
@class CLLocation, NSDate, NSDictionary, NSString, NSURL, PFVideoAVObjectBuilder, PHAdjustmentData, UIImage;
...
@property(readonly, nonatomic) NSDictionary *providedVideoAdjustments; // @synthesize providedVideoAdjustments=_providedVideoAdjustments;
...
@property(readonly, nonatomic) PHAdjustmentData *providedAdjustmentData; // @synthesize providedAdjustmentData=_providedAdjustmentData;
