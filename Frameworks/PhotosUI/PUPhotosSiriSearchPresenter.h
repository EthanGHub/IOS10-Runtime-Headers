...
@class NSString, PSIDatabase, PUFilteredMomentsDataSource, PUFilteredMomentsViewController, PUNavigationController, PUPhotosGridViewControllerSpec, PUPingTimer, PUSearchResultsDataSource, UIViewController;
...
@property(retain, nonatomic) PUFilteredMomentsViewController *searchResultsViewController; // @synthesize searchResultsViewController=_searchResultsViewController;
@property(retain, nonatomic) PUFilteredMomentsDataSource *photoCollections; // @synthesize photoCollections=_photoCollections;
