...
@class EKStructuredLocation, MKCircleRenderer, MKMapView, MKPointAnnotation, NSCache, NSMutableArray, NSObject, NSString, UISearchBar, UITableView, UIView;
@protocol OS_dispatch_queue;

@interface EKEventDetailLocationDisambiguationViewController : UIViewController <UISearchBarDelegate, MKMapViewDelegate, UITableViewDelegate, UITableViewDataSource>
{
