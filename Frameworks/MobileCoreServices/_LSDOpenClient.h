...
- (void)finishOpenOperationWithURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)startOpenOperationWithURL:(id)arg1 applicationIdentifier:(id)arg2 documentIdentifier:(id)arg3 userInfo:(id)arg4 options:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
