...
- (void)getResourceValuesForKeys:(id)arg1 URL:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)getLocalizationDictionaryForTypeWithIdentifier:(id)arg1 UUID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (void)getShouldLogContextInitCallsWithCompletionHandler:(CDUnknownBlockType)arg1;
...
- (void)getLocalizedNameWithBundleType:(id)arg1 bundleIdentifier:(id)arg2 bundleUUID:(id)arg3 context:(id)arg4 shortNameOnly:(_Bool)arg5 completionHandler:(CDUnknownBlockType)arg6;
