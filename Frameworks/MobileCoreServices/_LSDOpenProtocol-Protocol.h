...
- (void)finishOpenOperationWithURL:(NSURL *)arg1 completionHandler:(void (^)(_Bool, NSError *))arg2;
- (void)startOpenOperationWithURL:(NSURL *)arg1 applicationIdentifier:(NSString *)arg2 documentIdentifier:(NSString *)arg3 userInfo:(id)arg4 options:(NSDictionary *)arg5 completionHandler:(void (^)(_Bool, NSError *))arg6;
@end
